...
public class Bird {
	 ...
	 private int x;
	    ...
	    public boolean intersects(ColumnArriba column) {
	    ...
	    public boolean intersects(ColumnAbajo column) {
	        Rectangle birdRect = new Rectangle(x, y, birdImage.getIconWidth(), birdImage.getIconHeight());
	        Rectangle columnRect = new Rectangle(column.getX(), column.getGapStart(), column.getWidth(), column.getHeight() - column.getGapStart());
	        return birdRect.intersects(columnRect);
	    }
