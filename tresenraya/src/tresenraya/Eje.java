...
public class Eje extends javax.swing.JFrame {
	...
	// Seccion de botones del tablero
	    ...
	    public static void main(String args[]) {
	        ...
	        try {
	            ...
	            java.util.logging.Logger.getLogger(Eje.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
